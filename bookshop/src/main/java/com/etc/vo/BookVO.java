...
public class BookVO {
    ...
    public BookVO(int bookId, String bookName, int sortIdOne, int sortIdTwo, int sortIdThree, int userId, String bookAuthor, String bookBrief, int bookStats, String photo, int chaptersId, String chaptersName) {
        this.bookId = bookId;
